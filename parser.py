...
research_paper = open("research_paper.csv","w+",encoding = "utf8")
authorfile = open("author.csv","w+",encoding = "utf8")
citingfile = open("citation.csv","w+",encoding = "utf8")
...
authoringfile = open("authoring.csv","w+",encoding = "utf8") 
